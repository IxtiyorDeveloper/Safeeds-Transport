        ...
        <div className="sAll">
            <div className="sInfo">
                <div className="title pd">
                    Auto Transport Brokers Versus Carriers
                </div>
                <div className="cards pd">
                    <div className="box">
                        <div className="mi">
                            <img
                                src="https://mercuryautotransport.com/wp-content/uploads/2022/03/pasted-image-0-1-1-768x512.png"
                                alt="mi"
                                className="mainImg"
                            />
                        </div>
                        ...
                        <div className="text1">
                            ...
                            appropriate
                            carrier for you. We have access to a wide range of car transporters through National
                            Dispatch
                            Boards, and together with you, we can often strategize and negotiate far better rates. Not
                            all
                            brokers are created equal in this talent.
                        </div>
                    </div>
                    <div className="box">
                        <div className="mi">
                            <img
                                src="https://mercuryautotransport.com/wp-content/uploads/2022/03/pasted-image-0-1536x1023.png"
                                alt="mi"
                                className="mainImg"
                            />
                        </div>
